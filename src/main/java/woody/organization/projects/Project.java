 ...
 */
public class Project extends TenantAware implements HasComments, HasRelations, Journaled {

    public static final Column TYPE = Column.named("type");
    private final EntityRef<ProjectType> type = EntityRef.on(ProjectType.class, EntityRef.OnDelete.REJECT);
    ...
    public EntityRef<ProjectType> getType() {
        return type;
    }
